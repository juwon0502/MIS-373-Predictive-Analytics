...
st.write("#### Classification Accuracy (on out of sample): ", round(float(accuracy_score(model.predict(X_test), y_test)),4))
st.write("#### Classification Accuracy (training): ", round(float(accuracy_score(model.predict(X_train), y_train)),4))
